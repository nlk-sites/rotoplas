                ...
                <div class="sidebar">
                  <div class="row contacteachcontent1">
                    <div class="col-xs-5 col-sm-5 col-md-5 imagecontent">
                      <img class="img-responsive newsimage" src="<?php bloginfo('template_url'); ?>/images/customerserviceimage1.jpg">
                    </div>
                  ...
                  <div class="row eachcontent">
                    <div class="col-xs-5 col-sm-5 col-md-5 imagecontent">
                        <img class="img-responsive newsimage" src="<?php bloginfo('template_url'); ?>/images/customerserviceimage2.jpg">
                    </div>
                    <div class="col-xs-7 col-sm-7 col-md-7">
                  ...
                  <div class="row content">
                    <div class="col-xs-5 col-sm-5 col-md-5 imagecontent">
                        <img class="img-responsive newsimage" src="<?php bloginfo('template_url'); ?>/images/customerserviceimage3.jpg">
                    </div>
                    <div class="col-xs-7 col-sm-7 col-md-7">
