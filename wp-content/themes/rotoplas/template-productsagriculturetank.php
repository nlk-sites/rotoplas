<?php
/**
 * Template Name: Product Listing Agricultural Tanks
 *
...
get_header(); ?>
	<style type="text/css">
		.wrapper.literaturecontent {
		    background: transparent url("<?php bloginfo('template_url'); ?>/images/newcontent_bg2.jpg") no-repeat scroll 0px 0px / cover;
		    min-height: 1154px;
		}
	</style>
             ...
             <div class="row archive-tabs">
					 ...
					 <!-- Nav tabs -->
					  <ul class="nav nav-tabs" role="tablist">
					    ...
					    <li role="presentation" class="active"><a href="#agriculturaltanks" aria-controls="agriculturaltanks" role="tab" data-toggle="tab">Agricultural Tanks</a></li>
